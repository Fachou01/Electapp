...
function General() {
	...
	return (
		<Card>
			<label for="default-input" class="block mb-2 text-mb font-medium text-gray-900 dark:text-white">General Settings</label>
			<form className='p-10  '>
				<div class="mb-6">
				...
				<div>
					...
					<div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
						...
						<div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
							...
							<textarea id="desc" rows="8" class="block w-full p-2  -my-1 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
						</div>
					</div>
				</div>
			</form>
