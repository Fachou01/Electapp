...
function General() {
    ...
    return (
        ...
        // <Container>
            ...
            <label htmlFor="default-input" className="block mb-2 text-mb font-medium text-gray-900 dark:text-white">General Settings</label>
                <form className='p-10  '>
                    <div className="mb-6">
                    ...
                    <div>
                        ...
                        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <textarea id="desc" rows="8" className="block w-full p-2  -my-1 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                            </div>
                        </div>
                    </div>
                </form>
